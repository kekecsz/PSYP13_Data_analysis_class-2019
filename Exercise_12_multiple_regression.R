...
# "The multiple regression model was significantly better than the null model, explaining ...% of the variance in housing price (F (df1, df2) =  f-value, p = p-value, AIC = AIC)."	
...
# In our example the regression coefficient linked to sqm_living is .... This means that an increas in the area of the apartment by 1 m^2 results in an increased estimate in the price of the apartment by ....	
